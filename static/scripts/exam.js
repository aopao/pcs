...
$().ready(function () {
    ...
    // $('ul li.option label').click(function () {
    //     debugger;
    ...
    $.getJSON("/exam/getQuestions", function (response) {
        if (response.success) {
            exam.examVue.hollandQuestions = response.data;
        } else {
            alert(response.message);
        }
    });
    // $("#showRankBtn").click(function () {
    //     window.location.href = "/contest/score/" + $("#contestId").val()
    // });
});
